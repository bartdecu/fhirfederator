...
public class TestResourceConfigEvaluator {
    ...
    public void  TestTrue(){
        ...
        Boolean actual = new ResourceConfigEvaluator(FhirContext.forR4Cached(), Read.class, null, config).execute();
    ...
    public void  TestFhirPathWrong(){
        ...
        Boolean actual = new ResourceConfigEvaluator(FhirContext.forR4Cached(), Read.class, patient, config).execute();
